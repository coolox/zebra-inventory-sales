...
export const copy = {
  en: {
    ...
    goalPeriod: { day: "Daily", week: "Weekly", month: "Monthly", year: "Yearly" }, goalRevenueTarget: "revenue target", edit: "Edit", save: "Save", progress: "Progress", of: "of", checkingAccess: "Checking secure workspace access…", signOut: "Sign out", signingOut: "Signing out…",
  ...
  tr: {
    ...
    goalPeriod: { day: "Günlük", week: "Haftalık", month: "Aylık", year: "Yıllık" }, goalRevenueTarget: "ciro hedefi", edit: "Düzenle", save: "Kaydet", progress: "İlerleme", of: "/", checkingAccess: "Güvenli çalışma alanı erişimi kontrol ediliyor…", signOut: "Çıkış yap", signingOut: "Çıkış yapılıyor…",
