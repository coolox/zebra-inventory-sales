...
| Backup freshness | Recovery rehearsal and encrypted artifact cover staging only; no fresh production checkpoint/configuration evidence exists | **BLOCKER for GO** |
