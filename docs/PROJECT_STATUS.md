...
- TASK-049 — вынести Inventory list feature; затем TASK-050—TASK-052 dashboard decomposition/routing.
...
- [TASK-049](tasks/TASK-049.md) — Вынести Inventory list feature
