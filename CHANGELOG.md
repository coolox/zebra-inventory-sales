...
- Recorded the Owner decision to add private-model thumbnails to Inventory and a server-authorized Seller sales summary: store today/week plus personal today/week/month/year/all-time totals. Work is split into TASK-139—TASK-141.
