...
type Copy = { title: string; subtitle: string; store: string; personal: string; today: string; week: string; month: string; year: string; allTime: string; revenue: string; units: string; loading: string; error: string; retry: string; empty: string; unavailable: string };
const copy: Record<Locale, Copy> = {
  en: { title: "Sales summary", subtitle: "Live EUR revenue and sold units", store: "Store sales", personal: "My sales", today: "Today", week: "This week", month: "This month", year: "This year", allTime: "All time", revenue: "Revenue", units: "units", loading: "Loading sales summary…", error: "Sales summary could not be loaded.", retry: "Retry", empty: "No confirmed sales in these periods yet.", unavailable: "Your live sales summary will appear after secure sign-in." },
  tr: { title: "Satış özeti", subtitle: "Canlı EUR ciro ve satılan adet", store: "Mağaza satışları", personal: "Satışlarım", today: "Bugün", week: "Bu hafta", month: "Bu ay", year: "Bu yıl", allTime: "Tüm zamanlar", revenue: "Ciro", units: "adet", loading: "Satış özeti yükleniyor…", error: "Satış özeti yüklenemedi.", retry: "Tekrar dene", empty: "Bu dönemlerde henüz onaylanmış satış yok.", unavailable: "Canlı satış özetiniz güvenli girişten sonra görünecek." },
};
