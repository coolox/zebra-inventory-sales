  ...
  return (
    <section className="mt-6 border-t border-zinc-800 pt-5" aria-label={text.title}>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        {isOpen ? <div className="flex shrink-0 gap-2"><button type="button" onClick={refresh} className="flex h-9 items-center gap-1.5 rounded-lg border border-zinc-700 px-3 text-xs font-semibold text-zinc-300 transition hover:border-zinc-600 hover:text-white"><RefreshCw size={14} aria-hidden="true" /> {text.refresh}</button><button type="button" onClick={() => setIsOpen(false)} className="flex h-9 items-center gap-1.5 rounded-lg border border-zinc-700 px-3 text-xs font-semibold text-zinc-400 transition hover:border-zinc-600 hover:text-zinc-200"><ChevronDown size={14} aria-hidden="true" /> {text.hide}</button></div> : <button type="button" aria-expanded="false" onClick={open} className="flex h-9 shrink-0 items-center gap-1.5 self-start rounded-lg border border-violet-500/35 bg-violet-500/10 px-3 text-xs font-semibold text-violet-200 transition hover:bg-violet-500/15 sm:self-auto"><ChevronDown size={14} aria-hidden="true" /> {text.view}</button>}
      </div>
